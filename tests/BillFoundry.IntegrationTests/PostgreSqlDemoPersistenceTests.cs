...
public sealed class PostgreSqlDemoPersistenceTests
{
    private readonly PostgreSqlFixture _postgres;

    public PostgreSqlDemoPersistenceTests(PostgreSqlFixture postgres)
    {
        _postgres = postgres;
    }

    [Fact]
    public async Task Migrates_seeds_and_runs_critical_demo_workflows()
    {
