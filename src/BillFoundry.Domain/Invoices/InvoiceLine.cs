...
/// <summary>
/// A historical snapshot of a billed invoice line. Catalog price changes do not update it.
/// </summary>
public sealed class InvoiceLine : IAuditable
{
    ...
    internal InvoiceLineAmount ToAmount() => new(Quantity, UnitPrice, IsTaxable);
        ...
        int sortOrder)
    {
        ...
        IsTaxable = isTaxable;
        SortOrder = sortOrder;
        LineAmount = InvoiceCalculator.LineAmount(quantity, unitPrice);
    }
}
